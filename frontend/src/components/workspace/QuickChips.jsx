...
export const QuickChips = ({ activeChip, onChipClick }) => {
  return (
    <div
      ...
      {QUICK_CHIPS.map((chip) => {
        ...
        return (
          <button
            ...
            className={`ma-focus ma-chip flex h-10 items-center gap-2 rounded-full border px-4 text-sm font-medium transition-colors duration-150 ease-out active:scale-[0.97] ${
              active
